...
//    }
    ...
    public void handlerNewType3() {
        ...
        String event3 = "{\n" +
                "  \"id\": \"6cc649cf-55e7-42b6-8626-9db8ec0ac580\",\n" +
                "  \"source\": \"/http-to-messaging-adapter\",\n" +
                "  \"type\": \"httpEnvelop\",\n" +
                "  \"specversion\": \"0.2\",\n" +
                "  \"time\": \"2019-09-26T22:40:30.308Z\",\n" +
                "  \"schemaurl\": null,\n" +
                "  \"contenttype\": \"application/json\",\n" +
                "  \"data\": {\n" +
                "    \"header\": {\n" +
                "      \"x-real-ip\": \"10.240.0.4\",\n" +
                "      \"referer\": \"http://104.45.11.194/\",\n" +
                ...
                "      \"type\": \"topic\",\n" +
                "      \"id\": \"OutPut\",\n" +
                "      \"timestamp\": \"2019-09-26T22:40:30.309Z\"\n" +
                "    },\n" +
                "    {\n" +
                "      \"type\": \"faas-function\",\n" +
                "      \"id\": \"messaging-to-http-adapter\",\n" +
                "      \"timestamp\": \"2019-09-26T22:40:30.488Z\"\n" +
                "    }\n" +
                "  ],\n" +
                "  \"routingslip\": null,\n" +
                "  \"istestmessage\": false,\n" +
                ...
                "  \"dataref\": null,\n" +
                "  \"subject\": null,\n" +
                "  \"adapterRequestUrl\": \"http://conduit.productionready.io/api/tags\",\n" +
                "  \"adapterRequestMethod\": \"GET\",\n" +
                "  \"backendUrl\": \"demo.productionready.io/api\"\n" +
                "}";
        Request request = new Request(event3, null);
        IResponse response = handler.Handle(request);
